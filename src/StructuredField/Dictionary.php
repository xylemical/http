...
final class Dictionary extends StructuredField implements IteratorAggregate, ArrayAccess, Countable {
   ...
   *
   * @param \Xylemical\Http\StructuredField\StructuredFieldSequenceInterface[] $map
   *   The map.
   */
   ...
   * @param string $key
   *   The key.
   * @param \Xylemical\Http\StructuredField\StructuredFieldSequenceInterface|null $default
   *   A default item.
   *
